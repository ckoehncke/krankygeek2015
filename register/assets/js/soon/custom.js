...
(function($) {
    ...
    **/
    var launch = new Date(2014, 05, 27, 12, 00);
    /**
    * The script
    **/
    var message = $('#message');
    ...
    function setDate(){
        ...
        if( launch < now ){
            ...
            message.html("WE'RE NOT QUITE READY TO TAKE YOUR REGISTRATION");
        }
        else{
            ...
            message.html('EVENT REGISTRATION STARTS 2 WEEKS PRIOR TO EVENT 27. JUNE 2014');
        }
    }
})(jQuery);
/******************************************************************************************************************************
